...
export function Register(){
  ...
  <><div className="main-content">
        ...
        <h5>Sign up to listen podcasts and share with your frinds.</h5>
        </div>
  ...
  <div className="line"></div>
        ...
        <div className="l-part">
            ...
            {/* <p className="policy">People who use our service may have uploaded your contact information to Instagram.<span className="span"> Learn More</span>
<br/>By signing up, you agree to our <span className="span"> Terms Privacy Policy and Cookies Policy</span> </p> */}
