...
export function Popup(props: any) {
    ...
    const AddExperience = (e: any) => {
        ...
        const body = {
            avatar: "https://media-exp1.licdn.com/dms/image/C560BAQFrJStbvraiXw/company-logo_100_100/0/1519117083891?e=1667433600&v=beta&t=zWEmBCyhvwUNW_VtLFxdsOGc0CrDp9cepY0YYoeQitI",
